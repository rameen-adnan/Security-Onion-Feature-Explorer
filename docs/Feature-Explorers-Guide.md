...
### Background: Elastic Fleet vs. Wazuh
...
### 2.3 Elastic Fleet: What Was Explored
...
#### 2.3.2 Fleet Server Agent Details
...
#### 2.3.3 Security Onion Node Agent Details
...
#### 2.3.4 Agent Policy: so-grid-nodes_general
...
#### 2.4.4 Osquery in Eval Mode — Scope & Limitations
